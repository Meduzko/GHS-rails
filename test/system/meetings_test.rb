...
class MeetingsTest < ApplicationSystemTestCase
  ...
  test "creating a Meeting" do
    ...
    fill_in "Accepted Solutions", with: @meeting.accepted_solutions
    fill_in "Agenda", with: @meeting.agenda
    fill_in "Announcement", with: @meeting.announcement
    fill_in "Consideration Docs", with: @meeting.consideration_docs
    fill_in "Solutions", with: @meeting.solutions
